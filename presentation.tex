...
\subtitle{Architectural Evolution from LSTMs to Non-Linear Multi-Kernel DLinear}
...
% ==========================================
% SLIDE 10: ARCHITECTURAL INNOVATION 2: NON-LINEAR & MULTI-KERNEL DLINEAR
% ==========================================
\begin{frame}{Architectural Innovation 2: Introducing Non-Linearity into DLinear}
  \begin{columns}[T]
    \begin{column}{0.55\textwidth}
      \centering
