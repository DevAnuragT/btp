...
% ==========================================
\begin{frame}{ML Explainability: SHAP \& Integrated Gradients}
  \begin{columns}[c]
    \begin{column}{0.48\textwidth}
      \small
      \begin{block}{Integrated Gradients (IG) Attribution}
        \begin{itemize}
          \item \textbf{Demand Signals} (sales, discounts) and \textbf{Inventory Signals} (stockouts) act on different temporal scales.
          \item Demand exhibits fast 1--3 day velocity; inventory exhibits 7-day weekly seasonality.
        \end{itemize}
      \end{block}
      
      \begin{alertblock}{Identification of Feature Cross-Talk}
        \begin{itemize}
          \item Feeding both signals into a single shared LSTM cell causes \textbf{gradient noise and interference}.
          \item Inspired the \textbf{Dual-Stream Decoupling} design to cleanly isolate feature types.
        \end{itemize}
      \end{alertblock}
    \end{column}
    ...
    \begin{column}{0.48\textwidth}
      \centering
      \includegraphics[width=\textwidth]{images/explainability_flow.png}\\
      \vspace{4pt}
      \scriptsize Figure 2: IG Feature \& Temporal Attribution Flow
    \end{column}
  \end{columns}
\end{frame}
