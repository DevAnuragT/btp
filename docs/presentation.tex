...
\begin{frame}{ML Explainability: Integrated Gradients Analysis}
  \begin{columns}[c]
    \begin{column}{0.55\textwidth}
      \centering
      \includegraphics[width=\textwidth,height=5.6cm,keepaspectratio]{images/ig_heatmap.png}\\
      \vspace{1pt}
      \tiny{Attribution heatmap: all 11 features \& 14-day history (D-1 = most recent)}
    \end{column}
    \begin{column}{0.43\textwidth}
      \centering
      \includegraphics[width=\textwidth,height=5.6cm,keepaspectratio]{images/ig_barplot.png}\\
      \vspace{1pt}
...
\begin{frame}{Limitations of Baseline LSTM}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \centering
      \includegraphics[width=\textwidth,height=4.8cm,keepaspectratio]{images/lstm_cell.pdf}\\
      \vspace{2pt}
      \tiny{Standard LSTM Cell Architecture}
    \end{column}
    \begin{column}{0.48\textwidth}
      \centering
      \includegraphics[width=\textwidth,height=4.8cm,keepaspectratio]{images/normal_lstm_variations_comparison.png}\\
      \vspace{2pt}
  ...
  \begin{alertblock}{Why Scaling Alone Doesn't Help}
    ...
    \begin{itemize}
      ...
      \item Demand \& inventory share hidden state $h_t$ $\Rightarrow$ potential for \textbf{feature interference}.
      \item IG analysis (prev. slide) shows distinct temporal behaviors, motivating \textbf{dedicated streams}.
    \end{itemize}
  \end{alertblock}
\end{frame}
