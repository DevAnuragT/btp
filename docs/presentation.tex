  ...
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      ...
      \begin{block}{SKU Statistical Ranking Formula}
        \small
        $\text{Score} = 0.40 \times \text{Sales} + 0.25 \times \text{Stockout Hours}$\\
        $+ 0.20 \times \text{Stockout Days} + 0.15 \times \text{Sales Std}$
      \end{block}
    \end{column}
...
% ==========================================
\begin{frame}{ML Explainability: Integrated Gradients Analysis}
  \begin{columns}[c]
    \begin{column}{0.55\textwidth}
      \centering
      \includegraphics[width=\textwidth,height=5.8cm,keepaspectratio]{images/ig_heatmap.png}\\
      \vspace{1pt}
      \tiny{Attribution heatmap: all 11 features \& 14-day history (D-1 = most recent)}
    \end{column}
    \begin{column}{0.43\textwidth}
      \centering
      \includegraphics[width=\textwidth,height=5.8cm,keepaspectratio]{images/ig_barplot.png}\\
      \vspace{1pt}
      \tiny{Feature importance: top 6 (highlighted) far outrank remaining 5}
      \vspace{3pt}
      \begin{exampleblock}{\scriptsize Observation $\rightarrow$ Selection}
        \scriptsize
        Out of all 11 features, IG reveals 6 features consistently dominate. Notably, \textbf{inventory features exhibit 7-day weekly seasonality}, while \textbf{demand features show a rapid 1--2 day velocity}. This motivates our feature reduction to 6 signals and the dual-stream split between demand \& inventory.
      \end{exampleblock}
    \end{column}
  \end{columns}
\end{frame}
...
% ==========================================
% SLIDE 8: LIMITATIONS OF BASELINE LSTM
% ==========================================
\begin{frame}{Limitations of Baseline LSTM}
  \begin{columns}[T]
    \begin{column}{0.35\textwidth}
      \centering
      \vspace{0.3cm}
      \includegraphics[width=\textwidth,keepaspectratio]{images/lstm_cell.pdf}\\
      \vspace{2pt}
      \tiny{Standard LSTM Cell Architecture}
    \end{column}
    \begin{column}{0.62\textwidth}
      \centering
      \includegraphics[width=\textwidth,height=4.0cm,keepaspectratio]{images/normal_lstm_variations_comparison.png}\\
      \vspace{1pt}
      \tiny{F1-Score across LSTM hidden size variants (h=8 to h=96)}
      \vspace{4pt}
      \begin{alertblock}{Why Scaling Alone Doesn't Help}
        \footnotesize
        \begin{itemize}
          \item \textbf{F1 plateau} at $\sim$0.789 regardless of hidden size --- more params yield no gain.
          \item Demand \& inventory share hidden state $h_t$ $\Rightarrow$ \textbf{feature cross-talk}.
          \item IG analysis (prev. slide) proves these signals need \textbf{dedicated streams}.
        \end{itemize}
      \end{alertblock}
    \end{column}
  \end{columns}
...
\begin{frame}{Our Fix: Dual-Stream Inventory Shortcut LSTM}
  \begin{columns}[T]
    \begin{column}{0.44\textwidth}
      \centering
      \includegraphics[width=\textwidth,height=4.8cm,keepaspectratio]{architecture.jpeg}\\
      \vspace{1pt}
      \tiny{Dual-Stream: Demand LSTM + Inventory LSTM + Day-14 Shortcut}
    \end{column}
    \begin{column}{0.54\textwidth}
      \centering
      \includegraphics[width=\textwidth,height=4.2cm,keepaspectratio]{images/dualstream_evolution_comparison.png}\\
      \vspace{1pt}
      \tiny{F1, Recall \& MAE: all dual-stream variants vs.~baseline LSTM}
      \vspace{4pt}
