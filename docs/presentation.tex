  ...
  \begin{columns}[c]
    ...
    \begin{column}{0.43\textwidth}
      ...
      \begin{exampleblock}{\scriptsize Observation $\rightarrow$ Selection}
        \scriptsize
        Out of all 11 features, IG reveals the same 6 features consistently dominate across time steps and samples. Weather \& activity features show near-zero attribution. This motivates our \textbf{feature reduction to 6 signals} and the dual-stream split between demand \& inventory.
      \end{exampleblock}
    \end{column}
  \end{columns}
\end{frame}
