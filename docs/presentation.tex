...
\begin{frame}{ML Explainability: Integrated Gradients Analysis}
  \begin{columns}[c]
    \begin{column}{0.55\textwidth}
      ...
      \vspace{1pt}
      \tiny{Attribution heatmap: all 13 features \& 14-day history (D-1 = most recent)}
    \end{column}
    \begin{column}{0.43\textwidth}
      \centering
      \includegraphics[width=\textwidth,height=5.8cm,keepaspectratio]{images/ig_barplot.png}\\
      \vspace{1pt}
      \tiny{Feature importance: top 6 (highlighted) far outrank remaining 7}
      \vspace{3pt}
      \begin{exampleblock}{\scriptsize Observation $\rightarrow$ Selection}
        \scriptsize
        Out of all 13 features, IG reveals the same 6 features consistently dominate across time steps and samples. Weather \& activity features show near-zero attribution. This motivates our \textbf{feature reduction to 6 signals} and the dual-stream split between demand \& inventory.
      \end{exampleblock}
    \end{column}
  \end{columns}
\end{frame}
