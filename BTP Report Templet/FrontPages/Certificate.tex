...
\end{center}
\vspace{0.5cm}
\noindent We hereby certify that the work, which is being presented in the report/thesis, entitled \textbf{Title}, in fulfillment of the requirement for the award of the degree of \textbf{Integrated Post Graduate Master of Technology (IPG-M.Tech)} and submitted to the institution is an authentic record of my/our own work carried out during the period May 2025 to August 2025 under the supervision of \textbf{Dr. XX}. We also cited the reference about the text(s)/figure(s)/table(s) from where they have been taken.
