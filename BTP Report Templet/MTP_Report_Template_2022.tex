...
\include{chapters/1/introduction}\label{chap:intro}
\clearpage
\thispagestyle{empty}
\newpage

\include{chapters/2/literature_review}\label{chap:l_survey}
\clearpage
\thispagestyle{empty}
\newpage

\include{chapters/3/thesis_objectives}\label{chap:objectives}
\clearpage
\thispagestyle{empty}
\newpage

\include{chapters/4/system_architecture}\label{chap:methodology}
\clearpage
\thispagestyle{empty}
\newpage

\include{chapters/5/tasks_completed}\label{chap:tasks}
\clearpage
\thispagestyle{empty}
\newpage

\include{chapters/6/results}\label{chap:results}
\clearpage
\thispagestyle{empty}
\newpage 
